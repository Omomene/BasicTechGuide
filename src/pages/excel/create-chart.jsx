  ...
  return (
    <Layout>
      ...
      >
        ...
        <StepBlock title="Step 1 – Select Data" image="/assets/images/excel/create-chart/step1.png" alt="Select data for chart">
        ...
        <StepBlock title="Step 2 – Go to Insert Tab" image="/assets/images/excel/create-chart/step2.png" alt="Insert tab in Excel">
        ...
        <StepBlock title="Step 3 – Choose Chart Type" image="/assets/images/excel/create-chart/step3.png" alt="Choose chart type">
        ...
        <StepBlock title="Step 4 – Customize Chart" image="/assets/images/excel/create-chart/step4.png" alt="Customize chart">
        ...
        <StepBlock title="Step 5 – Final Chart" image="/assets/images/excel/create-chart/step5.png" alt="Completed chart">
